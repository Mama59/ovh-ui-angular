describe("ouiTile", () => {
    ...
    const getTileTitle = (element) => angular.element(element[0].querySelector(".oui-tile__title"));
    const getTileLegend = (element) => angular.element(element[0].querySelector(".oui-tile__legend"));
    ...
    describe("Component", () => {
        ...
        it("should display a tile with title and legend", () => {
            ...
            const element = TestUtils.compileTemplate(`<oui-tile title="${title}" legend="${legend}"></oui-tile>`);

            const tileTitle = getTileTitle(element);
            const tileLegend = getTileLegend(element);
